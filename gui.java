	...
	public static void main(String[] args)
	{
		...
		b1.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				File fileobj=new File("/home/wasifirshad/workspace/Javalab/file.txt");		//specify the path where you want the file 'file.txt' to be created to display employee details
				try
				{
