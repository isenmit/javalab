...
public class gui
{
	...
	public static void main(String[] args)
	{
		...
		GridLayout g1=new GridLayout(5,2); 					// specifying the layout of the frame
		frameobj.setLayout(g1);								//specifications of the layout are set to the frame created
		...
		JTextField f1=new JTextField();   					//create objects for TextField
		JTextField f2=new JTextField();
		JTextField f3=new JTextField();
		JTextField f4=new JTextField();

		f1.setPreferredSize(new Dimension(200,30)); 		//size of TextField
		f2.setPreferredSize(new Dimension(200,30));
		f3.setPreferredSize(new Dimension(200,30));
		f4.setPreferredSize(new Dimension(200,30));

		JButton b1=new JButton("SUBMIT");					//creates two buttons submit and reset
		...
		b1.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				File fileobj=new File("/home/harshitojha/workspace/Javalab/file.txt");		//specify the path where you want the file 'file.txt' to be created to display employee details
				try
				{
